...
-- Records of food
-- ----------------------------
INSERT INTO `food` VALUES (1, '菠菜炒鸡蛋', '暂无', '主料：菠菜300克，鸡蛋3个，盐、料酒、葱末、姜末、味精、香油各适量。', 9, 3, 'images/jiachang/01.jpg', 1, 0);
INSERT INTO `food` VALUES (2, '韭菜炒鸡蛋', '工艺：炒    口味：清香味', '主料：韭菜4两（约160克），大鸡蛋3只。\r\n', 8, 3, 'images/jiachang/02.jpg', 0, -1);
INSERT INTO `food` VALUES (3, '渝味辣白菜', '特色：色泽红亮、酸甜微辣，脆爽可口。', '主料：娃娃菜200克。', 6, 1, 'images/jiachang/03.jpg', 0, -1);
...
INSERT INTO `food` VALUES (6, '清蒸桂鱼', '特色：色泽淡稚悦目，味似蟹肉，鲜香馥郁。\r\n辅料：熟火腿3片（25克）， 熟笋6片（60克），水发大香菇3朵，姜片2.5克、葱结1个\r\n', '主料：桂鱼一条（约重750克）。', 25, 1, 'images/jiachang/06.jpg', 0, -1);
INSERT INTO `food` VALUES (7, '酸辣白菜', '口味：酸辣味。', '主料：大白菜 1/4棵（约400g）。', 14, 1, 'images/jiachang/07.jpg', 0, -1);
...
INSERT INTO `food` VALUES (10, '肉末豆腐', '特色：鲜嫩可口。功效：强壮身体，改善体质。', '暂无主料：嫩豆腐600 克，肉末150 克，酱油10 克，细盐3 克，味精3 克，黄酒5克，姜末5 克，葱花3 克，胡椒粉1 克，鲜汤300 克。', 7, 1, 'images/jiachang/10.jpg', 0, -1);
INSERT INTO `food` VALUES (11, '小葱拌豆腐', '特色：清香爽口，一清二白。', '暂无', 22, 2, 'images/liangcai/1.jpg', 0, 18);
...
INSERT INTO `food` VALUES (14, '凉拌海带丝', '特色：海带是一种海洋蔬菜，含碘、藻胶酸和甘露醇等，可防治甲状腺肿大、克汀病、软骨病、佝偻病。现代药理学研究表明，吃海带可增加单核巨噬细胞活性，增强机体免疫力和抗辐射', '主料：海带300克、蒜茸、香油、醋、味精等。', 8, 2, 'images/liangcai/4.jpg', 0, -1);
...
INSERT INTO `food` VALUES (18, '肉皮冻', '特色：透明、味鲜。', '主料：猪肉片500克，盐、味精、葱段、姜块(拍楹)花椒粒、大料瓣知适量。\r\n', 9, 2, 'images/liangcai/8.jpg', 0, -1);
INSERT INTO `food` VALUES (19, '凉拌藕片', '特色：爽口解腻、开胃下酒。', '主料：莲藕500克、酱油15克、精盐6克、味精2克、葱花3克、姜丝3克、蒜片3克。', 12, 2, 'images/liangcai/9.jpg', 0, -1);
INSERT INTO `food` VALUES (20, '蒜泥白肉', '暂无', '主料：猪臀肉500克。 大蒜50克、上等酱油50克、红油10克、盐2克、冷汤50克、红糖10克、香料3克、味精1克。', 20, 2, 'images/liangcai/10.jpg', 1, 15);
INSERT INTO `food` VALUES (21, '四川酸辣粉', '暂无', '粉条,葱末,姜末,蒜泥等', 28, 3, 'images/zhushi/1.jpg', 0, -1);
INSERT INTO `food` VALUES (22, '蛋包饭', '香啊\r\n', '蛋一个，炒饭6两', 6, 3, 'images/zhushi/2.jpg', 0, -1);
INSERT INTO `food` VALUES (23, '海南鸡饭', '暂无', '鸡一只，白米,姜，香兰叶，辣椒等', 22, 3, 'images/zhushi/3.jpg', 0, -1);
INSERT INTO `food` VALUES (24, '皮蛋粥', '口味：清香味。', '稻米100克，松花蛋50克', 5, 3, 'images/zhushi/4.jpg', 1, -1);
...
INSERT INTO `food` VALUES (31, '甘蔗马蹄糖水', '暂无', '主料：甘蔗200克，马蹄150克，红枣50克，红糖50克，桂圆肉10克\r\n', 8, 4, 'images/yinpin/01.jpg', 1, -1);
INSERT INTO `food` VALUES (32, '抹茶慕司', '暂无', '主料：吉利丁片9片、红腰豆1瓶、淡奶油130g、白砂糖80g、鲜牛奶400g、蛋黄2个、抹茶粉4g。', 8, 4, 'images/yinpin/02.jpg', 0, -1);
INSERT INTO `food` VALUES (33, '瘦身苹果牛奶饮', '特色：苹果有安眠养神、补中益气、消食化积之特长。瘦身苹果牛奶饮让你首先感觉到的是苹果的甜香，然后是牛奶的浓郁、香滑。临睡前喝一碗，不但可以帮助睡眠，也不会长胖。', '主料：苹果250g,牛奶200g。', 11, 4, 'images/yinpin/03.jpg', 5, -1);
...
INSERT INTO `food` VALUES (38, '布丁', '暂无', '主料：鲜牛奶、ＱＱ糖、苹果（你爱吃那种水果就用那种，但最好跟ＱＱ糖口味一致，我觉得这样会比较好', 6, 4, 'images/yinpin/08.jpg', 0, 0);
...
INSERT INTO `food` VALUES (40, '姜撞奶', '暂无', '主料：鲜姜一大块，牛奶一袋，白糖，捣蒜缸', 17, 4, 'images/yinpin/10.jpg', 0, -1);

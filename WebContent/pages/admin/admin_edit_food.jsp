			...
			<div class="col-md-8 col-12">
				<div class="card border-warning">
					<div class="card-header border-warning bg-warning">
						<h5 class="text-center">修 改 书 籍</h5>
					</div>
					<form role="form" method="post" action="admin_edit_food_do.action"
						...
						<div class="card-body">
							...
							<div class="form-group">
								<label for="price">价格</label> <input type="number"
									class="form-control" name="price" id="price"
									required="required" value="<%=food.get("price")%>" />
								<p class="text-info">单位：元</p>
							</div>
							<div class="form-group">
								<label for="img">书籍图片</label> <input type="file" id="img"
									name="img" />
								<p class="text-info">请选择上传的书籍图片，大小应小于5M，扩展名为jpg,png或gif。</p>
								<img
							...
							<div class="form-group">
								...
								<p class="text-info">-1代表正常书，0代表店长推荐，正整数代表特价书价格。</p>
							</div>
						</div>
